 ...
 * @param style 样式
 */
export function prompt(content:string, title?:string, event?:MouseEvent,
...
export class Error extends ViewManager {
    ...
    protected height:any = 185;
    protected maxWidth:any = 440;
    ...
    public createView() {
        ...
        this.view.body.style.height = (this.coordinateParameter.bearingHeight - (toolbarHeight + operationHeight) - 25) + 'px';
